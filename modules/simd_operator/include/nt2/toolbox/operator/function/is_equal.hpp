...
namespace boost { namespace simd
{
  ...
  BOOST_SIMD_FUNCTION_IMPLEMENTATION(tag::is_equal_, is_equal , 2 )
  BOOST_SIMD_FUNCTION_IMPLEMENTATION(tag::is_equal_, eq      , 2 )
} }

#include <nt2/toolbox/simd_operator/function/scalar/is_equal.hpp>
#include <nt2/toolbox/simd_operator/function/simd/all/is_equal.hpp>
