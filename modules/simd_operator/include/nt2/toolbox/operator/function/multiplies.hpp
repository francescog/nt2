...
namespace boost { namespace simd
{
  ...
  BOOST_SIMD_FUNCTION_IMPLEMENTATION(tag::multiplies_             , multiplies      , 2 )
  BOOST_SIMD_FUNCTION_IMPLEMENTATION(tag::multiplies_             , mul             , 2 )
} }

#include <nt2/toolbox/simd_operator/function/scalar/multiplies.hpp>
#include <nt2/toolbox/simd_operator/function/simd/all/multiplies.hpp>
