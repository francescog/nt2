 ...
 ******************************************************************************/
#ifndef BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTION_SIMD_COMMON_BITWISE_XOR_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTION_SIMD_COMMON_BITWISE_XOR_HPP_INCLUDED
...
BOOST_SIMD_REGISTER_DISPATCH_IF(tag::bitwise_xor_, tag::cpu_,
    (A0)(A1)(X),
