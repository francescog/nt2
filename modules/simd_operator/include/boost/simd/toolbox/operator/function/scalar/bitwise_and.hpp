...
BOOST_SIMD_REGISTER_DISPATCH_IF ( tag::bitwise_and_ , tag::cpu_, (A0)(A1)
                         , (boost::mpl::equal_to< boost::mpl::sizeof_<A0>, boost::mpl::sizeof_<A1> >)
                         , tag::bitwise_and_(tag::fundamental_, tag::fundamental_)
...
namespace boost { namespace simd { namespace ext
{
  ...
  struct call<tag::bitwise_and_(tag::fundamental_, tag::fundamental_), tag::cpu_, Dummy> : callable
  {
