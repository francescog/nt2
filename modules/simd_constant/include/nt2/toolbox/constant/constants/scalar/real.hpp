...
////////////////////////////////////////////////////////////////////////////////
BOOST_SIMD_REGISTER_DISPATCH_TPL ( (tag::pattern<D,F>)
                          , tag::cpu_
...
BOOST_SIMD_REGISTER_DISPATCH(NAME,tag::cpu_,(A0), (target_< double_<A0> >) )   \
BOOST_SIMD_REGISTER_DISPATCH(NAME,tag::cpu_,(A0), (target_< float_<A0> >) )    \
...
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::m_zero_      ,0x8000000000000000LL, 0x80000000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::half_        ,0x3FE0000000000000LL, 0x3F000000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::third_       ,0x3FD5555555555555LL, 0x3EAAAAAB  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::quarter_     ,0x3FD0000000000000LL, 0x3E800000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::two_to_m10_  ,0x3F50000000000000LL, 0x3a800000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::two_to_nmb_  ,0x4330000000000000ll, 0x4b000000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::pi_          ,0x400921fb54442d18ll, 0x40490fdb  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::split_factor_,0x41a0000000000000ll, 0x46000000  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::sqrt_2_o_2_  ,0x3fe6a09e667f3bcdLL, 0x3f3504f3  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::sqrt_2_      ,0x3ff6a09e667f3bccll, 0x3fb504f3  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::gold_        ,0x3ff9e3779b97f4a8LL, 0x3fcf1bbd  )
BOOST_SIMD_CONSTANT_MAKE_REAL(tag::c_gold_      ,0x3fd8722191a02d61LL, 0x3ec3910d  )
//BOOST_SIMD_CONSTANT_MAKE_REAL(tag::nan_         ,0xFFFFFFFFFFFFFFFFLL, 0xFFFFFFFF  )
