...
//==============================================================================
#ifndef BOOST_SIMD_SDK_META_DETAILS_ANY_HPP_INCLUDED
#define BOOST_SIMD_SDK_META_DETAILS_ANY_HPP_INCLUDED
...
namespace boost { namespace simd { namespace details
{
  ...
  template< class Pred
          ...
          >
  struct  any_impl
        : boost::mpl::bool_<false BOOST_PP_REPEAT(BOOST_SIMD_MAX_META_ARITY,M1,~)>
  {};
