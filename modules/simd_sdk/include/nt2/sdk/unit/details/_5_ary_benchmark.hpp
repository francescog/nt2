 ...
 ******************************************************************************/
#ifndef BOOST_SIMD_SDK_UNIT_DETAILS__5_ARY_BENCHMARK_HPP_INCLUDED
#define BOOST_SIMD_SDK_UNIT_DETAILS__5_ARY_BENCHMARK_HPP_INCLUDED
                ...
                , const char* name = NULL )
{
  ...
  typedef typename boost::simd::meta::scalar_of<T3>::type t_in3;
  typedef typename boost::simd::meta::scalar_of<T4>::type t_in4;

  // output value
  typedef typename boost::simd::meta::result_of<
                         Func(r_in0,r_in1,r_in2,r_in3,r_in4)>::type out_t;
  static out_t                                                        out;
  ...
  std::cout << name << "("
            ...
            << ", " << boost::simd::type_id<r_in3>().c_str()  
            << ", " << boost::simd::type_id<r_in4>().c_str()  
            << ") " << std::flush;
  ...
  static const size_t c4 = boost::simd::meta::cardinal_of<r_in4>::value;
    ...
    boost::simd::tic();
    {
      ...
      for(size_t i=0; i<size/nb; i++)
      {
        out = callee( boost::simd::load<r_in0>(&in0[0],i)
                    ...
                    , boost::simd::load<r_in3>(&in3[0],i)
		    , boost::simd::load<r_in4>(&in4[0],i)
                    );
      }
