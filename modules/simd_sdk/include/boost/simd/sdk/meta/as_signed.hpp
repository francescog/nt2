...
//==============================================================================
#ifndef BOOST_SIMD_SDK_META_AS_SIGNED_HPP_INCLUDED
#define BOOST_SIMD_SDK_META_AS_SIGNED_HPP_INCLUDED
...
#include <boost/simd/sdk/meta/details/as_signed.hpp>
...
namespace boost { namespace simd { namespace meta
{
        ...
        : details::as_signed_impl< typename meta::strip<T>::type >
  {
    ...
    , BOOST_SIMD_NON_FUNDAMENTAL_PRIMITIVE_USED_IN_META_AS_SIGNED
