 ...
 ******************************************************************************/
#ifndef BOOST_SIMD_SDK_META_UPGRADE_HPP_INCLUDED
#define BOOST_SIMD_SDK_META_UPGRADE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace meta
{
  ...
  struct  upgrade
        : details::upgrade< typename meta::primitive_of<typename meta::strip<T>::type>::type
                          ...
                          >
  {
    BOOST_SIMD_STATIC_ASSERT ( (is_fundamental<typename meta::primitive_of<typename meta::strip<T>::type>::type>::value)
